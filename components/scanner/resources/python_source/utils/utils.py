...
def write_to_output(str_to_write, output):
...
def write_to_csv(arr_data, csv_writer):
    ...
    #print '\n'.join(['\t'.join([str(f) for f in e]) for e in arr_data])
    print u'\t'.join(arr_data)
...
def get_os_name(os_version):
    return {
        ...
        '8_1': 'windows8_1',
        '10': 'windows10',
        '2003Server': 'windows2003ServerR2',
        '2008Server': 'windows2008Server',
        '2008ServerR2': 'windows2008R2Server',
        '2012Server': 'windows2012Server',
        '2012R2Server': 'windows2012R2Server'
    }.get(os_version, 'windows7')
