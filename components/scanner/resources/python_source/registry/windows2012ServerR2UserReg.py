...
class Windows2012ServerR2UserReg(_Reg):
    ...
    def list_recent_docs(self):
        super(Windows2012ServerR2UserReg, self).csv_recent_docs()

    def list_startup_files(self):
        super(Windows2012ServerR2UserReg, self).csv_startup_programs()

    def list_MRU_history(self):
        super(Windows2012ServerR2UserReg, self).csv_run_mru_start()